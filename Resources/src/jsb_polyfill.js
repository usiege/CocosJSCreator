	...
	(function(i, n, o) {
		...
		4: [(function(i, n, o) {
			...
			function s(i, n) {
				...
				function r(i, r, s) {
					var a = i instanceof cc.Node && "position" === r,
						d = [],
						f = new l();
					f.target = i;
					var _, g = r.indexOf("."); -
				...
				var C = c.events;
				if (C)
					for (var T, b = 0, S = C.length; b < S; b++) {
						if (!T) {
							(T = new d()).target = i;
							a.push(T);
						}
						var E, x = C[b],
							A = x.frame / n.duration,
							N = p(T.ratios, A);
						if (N >= 0) E = T.events[N];
						else {
							E = new f();
			...
			var c = cc.js,
				a = i("./playable"),
				l = i("./animation-curves").DynamicAnimCurve,
				h = i("./animation-curves").quickFindIndex,
				u = i("./motion-path-helper").sampleMotionPaths,
				d = i("./animation-curves").EventAnimCurve,
				f = i("./animation-curves").EventInfo,
				_ = i("./types").WrapModeMask,
				p = i("../core/utils/binary-search").binarySearchEpsilon;
			c.extend(r, a);
			var g = r.prototype;
		...
		6: [(function(i, n, o) {
			...
			var s = i("./bezier").bezierByTime,
				c = i("../core/utils/binary-search").binarySearchEpsilon,
				a = i("./types").WrapModeMask,
				l = i("./types").WrappedInfo,
				h = cc.Class({
					name: "cc.AnimCurve",
					...
					sample: function(i, n, o) {
						...
						if (0 !== a) {
							...
							if (h < 0)
								...
								var u = s[h - 1],
									d = "number" === ("object" == (e = typeof u) ? t(u) : e),
									f = u && u.lerp;
								if (d || f) {
									var _ = c[h - 1],
										p = c[h],
				...
				sample: function(t, e, i) {
					...
					if (this._lastWrappedInfo) {
						var h = i.wrapMode,
							...
							f = this._wrapIterations(d.iterations),
							_ = d.frameIndex,
							p = d.direction,
							g = -1 !== f && u !== f;
						if (_ === s && g && 1 === n) this._fireEvent(0);
						else if (_ !== s || g) {
							r = p;
							do {
								if (_ !== s) {
					...
					if (!(t < 0 || t >= this.events.length || this._ignoreIndex === t)) {
						...
						if (this.target.isValid)
							for (var i = this.target._components, n = 0; n < e.length; n++)
								for (var o = e[n], r = o.func, s = 0; s < i.length; s++) {
									var c = i[s],
										a = c[r];
		...
		12: [(function(t, e, i) {
			...
			function r(t, e, i, o) {
				function r(t) {
					return t instanceof cc.Vec2 ? { in: t,
						pos: t,
						out: t
					} : Array.isArray(t) && 6 === t.length ? { in: h(t[2], t[3]),
						pos: h(t[0], t[1]),
						out: h(t[4], t[5])
					} : { in: cc.Vec2.ZERO,
						pos: cc.Vec2.ZERO,
			...
			var s = t("./animation-curves").DynamicAnimCurve,
				c = t("./animation-curves").computeRatioByType,
				a = t("./bezier").bezier,
			...
			o.prototype.getPoint = function(t) {
				var e = a(this.start.x, this.startCtrlPoint.x, this.endCtrlPoint.x, this.end.x, t),
					i = a(this.start.y, this.startCtrlPoint.y, this.endCtrlPoint.y, this.end.y, t);
				return new h(e, i);
			};
			...
			o.prototype.getUtoTmapping = function(t, e) {
				var i, n = this.getLengths(),
					...
					r = n.length;
				i = e || t * n[r - 1];
				for (var s, c = 0, a = r - 1; c <= a;)
					if ((s = n[o = Math.floor(c + (a - c) / 2)] - i) < 0) c = o + 1;
					else {
						if (!(s > 0)) {
							a = o;
							break;
			...
			r.play = function() {
				if (this._isPlaying)
					if (this._isPaused) {
						this._isPaused = !1;
						this.onResume();
					} else this.onError("already-playing");
				else {
					this._isPlaying = !0;
					this.onPlay();
				}
		...
		15: [(function(t, e, i) {
			...
			i.deprecated = function(t) {
				...
				n.get(t, "stopAllEffects", (function() {
					return function() {
						var n = t.getState(e) === t.AudioState.PLAYING,
							r = t.getCurrentTime(e);
						t.stopAll();
						if (n) {
							e = t.play(i, o);
		...
		16: [(function(i, n, o) {
			...
			var s = i("./utils/prefab-helper"),
				c = i("./utils/scene-graph-helper"),
				a = i("./event-manager"),
				l = cc.Object.Flags.Destroying,
				h = "position-changed",
				u = "size-changed",
				d = "anchor-changed",
				f = "rotation-changed",
				...
				C = [m.TOUCH_START, m.TOUCH_MOVE, m.TOUCH_END, m.TOUCH_CANCEL],
				T = [m.MOUSE_DOWN, m.MOUSE_ENTER, m.MOUSE_MOVE, m.MOUSE_LEAVE, m.MOUSE_UP, m.MOUSE_WHEEL],
				b = null,
				S = function(t, e) {
					var i = t.getLocation(),
						n = this.owner;
				...
				I = cc.Class({
					...
					_checkTouchListeners: function() {
						if (!(this._objFlags & l) && this._touchListener) {
							...
							if (this._bubblingListeners)
								for (; t < C.length; ++t)
									if (this._bubblingListeners.has(C[t])) return;
							if (this._capturingListeners)
								for (; t < C.length; ++t)
									if (this._capturingListeners.has(C[t])) return;
					...
					_checkMouseListeners: function() {
						if (!(this._objFlags & l) && this._mouseListener) {
							...
							if (this._bubblingListeners)
								for (; t < T.length; ++t)
									if (this._bubblingListeners.has(T[t])) return;
							if (this._capturingListeners)
								for (; t < T.length; ++t)
									if (this._capturingListeners.has(T[t])) return;
							b === this && (b = null);
					...
					getNodeToParentTransformAR: function() {
						...
						if (!this._isSgTransformArToMe(t)) {
							var i = this._anchorPoint.x * t.width,
								...
								o = cc.affineTransformMake(1, 0, 0, 1, i, n);
					...
					_getBoundingBoxTo: function(t) {
						var e = this.getContentSize(),
							i = e.width,
							n = e.height,
							o = cc.rect(-this._anchorPoint.x * i, -this._anchorPoint.y * n, i, n),
							r = cc.affineTransformConcat(this.getNodeToParentTransformAR(), t);
				...
				if (e._alignFlags & l) {
					...
					if (e.isStretchWidth) {
						...
						if (e.isAlignHorizontalCenter) {
							var E = e._isAbsHorizontalCenter ? e._horizontalCenter : e._horizontalCenter * C,
								x = (.5 - f.x) * a.width;
							if (c) {
								E *= s.x;
								x += r.x;
				...
				if (e._alignFlags & h) {
					...
					if (e.isStretchHeight) {
						...
						if (e.isAlignVerticalCenter) {
							var R = e._isAbsVerticalCenter ? e._verticalCenter : e._verticalCenter * O,
								P = (.5 - f.y) * a.height;
							if (c) {
								R *= s.y;
								P += r.y;
			...
			var n = cc.Class({
				...
				lateUpdate: function() {
					...
					var t = this.viewMatrix,
						e = this.invertViewMatrix,
						i = this.viewPort,
						n = cc.visibleRect,
						o = this.visibleRect,
						r = this.node.getNodeToWorldTransformAR(),
						s = .5 * -(Math.atan2(r.b, r.a) + Math.atan2(-r.c, r.d)),
						c = 1,
						a = 0,
						l = 0,
						h = 1;
			...
			var n = t("./CCContact"),
				...
				c = cc.Class({
					...
					_doCollide: function(t, e) {
						...
						var n, r, s, c = e.collider1,
							a = e.collider2,
							l = c.node._components,
							h = a.node._components;
					...
					updateCollider: function(t) {
						var e = t.offset,
							i = t.world,
							n = i.aabb,
							o = i.transform = t.node.getNodeToWorldTransformAR(),
							c = i.preAabb;
						c.x = n.x;
						c.y = n.y;
						c.width = n.width;
						...
						if (t instanceof cc.BoxCollider) {
							...
							var _ = Math.min(h.x, u.x, d.x, f.x),
								p = Math.min(h.y, u.y, d.y, f.y),
								g = Math.max(h.x, u.x, d.x, f.x),
								y = Math.max(h.y, u.y, d.y, f.y);
							n.x = _;
							n.y = p;
							n.width = g - _;
							n.height = y - p;
							...
							s.x = t.radius;
							s.y = 0;
							var m = cc.pointApplyAffineTransform(s, o),
								C = Math.sqrt(m.x * m.x + m.y * m.y);
							i.radius = C;
							n.x = v.x - C;
							n.y = v.y - C;
							n.width = 2 * C;
		...
		36: [(function(t, e, i) {
			function n(t, e) {
				...
				var i = t instanceof cc.BoxCollider || t instanceof cc.PolygonCollider,
					n = e instanceof cc.BoxCollider || e instanceof cc.PolygonCollider,
					r = t instanceof cc.CircleCollider,
					s = e instanceof cc.CircleCollider;
				if (i && n) this.testFunc = o.polygonPolygon;
				else if (r && s) this.testFunc = o.circleCircle;
				else if (i && s) this.testFunc = o.polygonCircle;
				else if (r && n) {
			...
			n.prototype.updateState = function() {
				...
				if (t && !this.touching) {
					this.touching = !0;
					e = r.CollisionEnter;
				} else if (t && this.touching) e = r.CollisionStay;
		...
		37: [(function(t, e, i) {
			function n(t, e, i, n) {
				var o = (n.x - i.x) * (t.y - i.y) - (n.y - i.y) * (t.x - i.x),
					r = (e.x - t.x) * (t.y - i.y) - (e.y - t.y) * (t.x - i.x),
			...
			c.lineRect = function(t, e, i) {
				var o = new cc.Vec2(i.x, i.y),
					r = new cc.Vec2(i.x, i.yMax),
					s = new cc.Vec2(i.xMax, i.yMax),
					c = new cc.Vec2(i.xMax, i.y);
			...
			c.rectPolygon = function(t, e) {
				var i, n, s = new cc.Vec2(t.x, t.y),
					c = new cc.Vec2(t.x, t.yMax),
					a = new cc.Vec2(t.xMax, t.yMax),
					l = new cc.Vec2(t.xMax, t.y);
				if (o(s, c, e)) return !0;
				if (o(c, a, e)) return !0;
				if (o(a, l, e)) return !0;
				if (o(l, s, e)) return !0;
			...
			c.polygonCircle = function(t, e) {
				...
				for (var n = 0, o = t.length; n < o; n++)
					if (s(i, 0 === n ? t[t.length - 1] : t[n - 1], t[n], !0) < e.radius) return !0;
				return !1;
			};
			c.pointInPolygon = r;
		...
		40: [(function(i, n, o) {
			...
			function s(t, e) {
				for (var i = t.array, n = t.i + 1; n < i.length;) {
					var o = i[n];
					if (o._enabled && o.node._activeInHierarchy) ++n;
					else {
						t.removeAt(n);
						e && (o._objFlags &= ~e);
					}
			...
			i("./platform/CCClass");
			var h = i("./platform/CCObject").Flags,
				u = i("./platform/js").array,
				d = h.IsStartCalled,
				f = h.IsOnEnableCalled,
				_ = (h.IsEditorOnEnableCalled,
					"c.start();c._objFlags|=" + d),
				p = "c.update(dt)",
				g = "c.lateUpdate(dt)",
				y = cc.Class({
					__ctor__: function(t) {
				...
				C = cc.Class({
					...
					_onDisabled: function(t) {
						...
						if (e >= 0) u.fastRemoveAt(this.scheduleInNextFrame, e);
						else {
		...
		41: [(function(t, e, i) {
			...
			var o = t("../../animation/animation-animator"),
		...
		43: [(function(t, e, i) {
			...
			var o = ["touchstart", "touchmove", "touchend", "mousedown", "mousemove", "mouseup", "mouseenter", "mouseleave", "mousewheel"],
				r = cc.Class({
			...
			var n = t("../event-manager"),
				...
				r = cc.Class({
					...
					__preload: function() {
						...
						r.instance = this;
						if (this.node._sizeProvider) {} else this.node._sizeProvider = o;
		...
		46: [(function(i, n, o) {
			var r = i("../platform/CCObject"),
				s = i("../platform/js"),
				c = new(i("../platform/id-generater"))("Comp"),
				a = r.Flags.IsOnEnableCalled,
				l = r.Flags.IsOnLoadCalled,
				h = cc.Class({
					name: "cc.Component",
					extends: r,
					ctor: function() {
		...
		48: [(function(t, e, i) {
			...
			var n = _ccsg.EditBox.KeyboardReturnType,
				o = _ccsg.EditBox.InputMode,
				r = _ccsg.EditBox.InputFlag,
				s = cc.Class({
					name: "cc.EditBox",
					extends: cc._RendererUnderSG,
					editor: !1,
		...
		49: [(function(i, n, o) {
			...
			var r = cc.TextAlignment,
				s = cc.VerticalTextAlignment,
				c = _ccsg.Label.Overflow,
				a = cc.Class({
					name: "cc.Label",
					extends: cc._RendererUnderSG,
					ctor: function() {
						...
						font: {
							...
							set: function(i) {
								...
								if (this._sgNode) {
									...
									var n = this.font;
									if (n instanceof cc.BitmapFont)
										if (n.spriteFrame)
											if (n.spriteFrame.textureLoaded()) this._sgNode.setFontAsset(n);
											else {
					...
					_initSgNode: function() {
						...
						if (i instanceof cc.BitmapFont)
							if (i.spriteFrame)
								if (i.spriteFrame.textureLoaded()) n = this._sgNode = new _ccsg.Label(this.string, JSON.stringify(i._fntConfig), i.spriteFrame);
								else {
					...
					_doLayoutHorizontally: function(t, e, i, r) {
						...
						l.forEach(function(l) {
							if (l.activeInHierarchy) {
								...
								var b = h * (1 - T) * l.width;
								if (e) {
									var S = f + b + h * (h > 0 ? this.paddingRight : this.paddingLeft),
										E = this.horizontalDirection === c.LEFT_TO_RIGHT && S > (1 - a.x) * t,
										x = this.horizontalDirection === c.RIGHT_TO_LEFT && S < -a.x * t;
									if (E || x) {
										if (l.height >= p) {
											0 === g && (g = p);
											_ += g;
					...
					_doLayoutVertically: function(t, e, i, r) {
						...
						l.forEach(function(l) {
							if (l.activeInHierarchy) {
								...
								if (e) {
									var S = f + b + h * (h > 0 ? this.paddingTop : this.paddingBottom),
										E = this.verticalDirection === s.BOTTOM_TO_TOP && S > (1 - a.y) * t,
										x = this.verticalDirection === s.TOP_TO_BOTTOM && S < -a.y * t;
									if (E || x) {
										if (l.width >= p) {
											0 === g && (g = p);
											_ += g;
					...
					_doLayoutBasic: function() {
						...
						if (t) {
							...
							var n = cc.size(parseFloat((i.x - e.x).toFixed(2)), parseFloat((i.y - e.y).toFixed(2))),
								...
								r = (o.x - e.x) / n.width,
								s = (o.y - e.y) / n.height,
								c = cc.p(parseFloat(r.toFixed(2)), parseFloat(s.toFixed(2)));
				...
				r = cc.Class({
					...
					_hitTest: function(t) {
						var e = this.node.getContentSize(),
							i = e.width,
							n = e.height,
							r = this.node.getNodeToWorldTransform();
				...
				s = cc.Class({
					...
					_updateAllPagesSize: function() {
						if (this.sizeMode === n.Unified)
							for (var t = this._pages, e = this.node.getContentSize(), i = 0, o = t.length; i < o; i++) t[i].setContentSize(e);
					},
					_initPages: function() {
						if (this.content) {
					...
					_handleReleaseLogic: function(t) {
						...
						if (e) {
							...
							var o = this._curPageIdx,
								r = o + this._getDragDirection(i),
								s = this.pageTurningSpeed * Math.abs(o - r);
				...
				o = cc.Class({
					...
					_updateBarStatus: function() {
						if (this.barSprite) {
							var t = this.barSprite.node;
							if (!t) return;
							var e, i, o, r = t.getAnchorPoint(),
								s = t.getContentSize(),
								c = t.getPosition(),
								a = cc.p(0, .5),
								l = cc.clamp01(this.progress),
								h = this.totalLength * l;
							switch (this.mode) {
								case n.HORIZONTAL:
							...
							if (this.mode === n.FILLED)
								if (this.barSprite.type !== cc.Sprite.Type.FILLED) cc.warn("ProgressBar FILLED mode only works when barSprite's Type is FILLED!");
								else {
									this.reverse && (h *= -1);
				...
				r = cc.Class({
					...
					_updateRichTextWithMaxWidth: function(t, e, i) {
						...
						if (this._lineOffsetX > 0 && n + this._lineOffsetX > this.maxWidth)
							for (var o = 0; this._lineOffsetX <= this.maxWidth;) {
								var r = this._getFirstWordLen(t, o, t.length),
									s = t.substr(o, r),
									c = this._measureText(i, s);
						...
						if (n > this.maxWidth)
							for (var l = cc.TextUtils.fragmentText(t, n, this.maxWidth, this._measureText(i)), h = 0; h < l.length; ++h) {
								var u = l[h],
					...
					_applySpriteFrame: function(t) {
						if (t)
							if (t.textureLoaded()) this._onSpriteFrameLoaded(null, t);
							else {
					...
					_addRichTextImageElement: function(t) {
						...
						if (i) {
							...
							var o = i.getRect(),
								...
								s = o.width,
								c = o.height,
								a = t.style.imageWidth,
								l = t.style.imageHeight;
				...
				o = cc.Class({
					...
					_onScroll: function(t) {
						if (this._scrollView) {
							...
							if (e) {
								...
								var u = this._calculateLength(s, c, h, a),
									d = this._calculatePosition(s, c, h, l, a, u);
					...
					_fixupHandlerPosition: function() {
						var t = this.node.getContentSize(),
							...
							r = this.node.convertToWorldSpaceAR(cc.p(-t.width * e.x, -t.height * e.y)),
							s = o.convertToNodeSpaceAR(r);
				...
				s = cc.Class({
					...
					_calculateMovePercentDelta: function(t) {
						...
						var o = this.node.getContentSize(),
							...
							s = this._getContentBottomBoundary() - this._bottomBoundary;
						s = -s;
					...
					_processAutoScrolling: function(t) {
						...
						var o = cc.pAdd(this._autoScrollStartPosition, cc.pMult(this._autoScrollTargetDelta, n)),
							r = Math.abs(n - 1) <= 1e-4;
						...
						if (this.elastic) {
							...
							var c = cc.pSub(o, this.getContentPosition()),
								a = this._getHowMuchOutOfBoundary(c);
					...
					_startAttenuatingAutoScroll: function(t, e) {
						var i = this._calculateAutoScrollTimeByInitalSpeed(cc.pLength(e)),
							n = cc.pNormalize(t),
							o = this.content.getContentSize(),
							r = this.node.getContentSize(),
							s = o.width - r.width,
							c = o.height - r.height,
							a = this._calculateAttenuatedFactor(s),
							l = this._calculateAttenuatedFactor(c);
				...
				o = cc.Class({
					...
					_updateProgress: function(t) {
						if (this.handle) {
							var e = null,
								i = 0,
								o = this.node.convertTouchToNodeSpaceAR(t);
							if (this.direction === n.Horizontal) {
		...
		63: [(function(t, e, i) {
			var n = t("./CCRendererUnderSG"),
				o = cc.Scale9Sprite.RenderingType,
				r = cc.Scale9Sprite.FillType,
				s = cc.BlendFunc.BlendFactor,
				c = cc.Enum({
					CUSTOM: 0,
					TRIMMED: 1,
					RAW: 2
				...
				a = cc.Class({
					...
					_applySpriteFrame: function(t, e) {
						...
						if (n) {
							...
							if (n.textureLoaded()) this._onTextureLoaded(null);
							else {
			...
			var n = cc.Class({
				...
				onEnable: function() {
					var t = this.node.getComponent("cc.Sprite"),
						e = this._spriteSGNode = t && t._sgNode;
		...
		69: [(function(i, n, o) {
			...
			var r = _ccsg.VideoPlayer.EventType,
				s = cc.Enum({
					REMOTE: 0,
					LOCAL: 1
				}),
		...
		74: [(function(t, e, i) {
			var n = cc.js,
				o = t("../utils/misc").BUILTIN_CLASSID_RE,
				r = cc.Class({
		...
		78: [(function(i, n, o) {
			...
			l.once = function(t, e, i, n) {
				var o = "__ONCE_FLAG:" + t,
					r = n ? this._capturingListeners : this._bubblingListeners;
				if (!(r && r.has(o, e, i))) {
					var s = this,
						c = function(a) {
							s.off(t, c, i, n);
			...
			l.dispatchEvent = function(t) {
				(function(t, e) {
					...
					for (n = a.length - 1; n >= 0; --n)
						if ((i = a[n])._isTargetActive(e.type) && i._capturingListeners) {
							e.currentTarget = i;
					...
					if (!e._propagationStopped && e.bubbles) {
						...
						for (n = 0; n < a.length; ++n)
							if ((i = a[n])._isTargetActive(e.type) && i._bubblingListeners) {
								e.currentTarget = i;
				...
				h = cc.Class({
					...
					off: function(t, e, i, n) {
						...
						if (c && (t === s.KEY_DOWN || t === s.KEY_UP)) {
							var o = this.hasEventListener(s.KEY_DOWN),
								l = this.hasEventListener(s.KEY_UP);
		...
		86: [(function(t, e, i) {
			var n = /^(click)(\s)*=/,
				o = /(\s)*src(\s)*=|(\s)*height(\s)*=|(\s)*width(\s)*=|(\s)*click(\s)*=/;
		...
		87: [(function(t, e, i) {
			...
			var o = {
				...
				_loadWithFontFace: function(t, e, i) {
					...
					if (o) o.isLoaded() || o.addHandler(i);
					else {
		...
		88: [(function(i, n, o) {
			...
			var c = i("../platform/js"),
				...
				d = i("./loader"),
				f = i("./asset-table"),
				_ = i("../platform/utils").callInNextTick,
				p = i("./auto-release-utils"),
				g = new f(),
				y = {
					url: null,
					raw: !1
				...
				for (var o = Object.getOwnPropertyNames(i), r = 0; r < o.length; r++) {
					...
					if ("object" === ("object" == (e = typeof c) ? t(c) : e) && c)
						if (Array.isArray(c))
							...
							} else if (c.constructor && c.constructor !== Object) c instanceof cc.RawAsset && s(c, n);
							else
								for (var h = Object.getOwnPropertyNames(c), u = 0; u < h.length; u++) {
									var d = c[h[u]];
			...
			n.exports = {
				autoRelease: function(t, e, i) {
					var n = cc.loader._autoReleaseSetting,
						o = l.createMap();
					if (e)
						for (var r = 0; r < e.length; r++) o[e[r]] = !0;
		...
		95: [(function(i, n, o) {
			...
			function s(t, e) {
				...
				var i = t.rawUrl,
					n = cc.textureCache.getTextureForKey(i) || new h();
				n.url = i;
		...
		96: [(function(i, n, o) {
			...
			function s(i, n) {
				var o = "object" === ("object" == (e = typeof i) ? t(i) : e) ? i.url : i,
					r = {
						queueId: n,
						id: o,
						url: o,
				...
				if ("object" === ("object" == (e = typeof i) ? t(i) : e)) {
					h.mixin(r, i);
					if (i.skips)
						for (var s = 0; s < i.skips.length; s++) {
							var c = i.skips[s];
			...
			var a = i("../platform/callbacks-invoker"),
				l = i("../utils/CCPath"),
				h = i("../platform/js"),
				u = 0 | 998 * Math.random(),
				d = {},
		...
		97: [(function(t, e, i) {
			...
			r.prototype.transformURL = function(t) {
				var e = t.indexOf("?"),
					i = t; -
				1 !== e && (i = t.substr(0, e));
				if (i.startsWith(this.libraryBase)) i = i.slice(this.libraryBase.length);
				else {
		...
		99: [(function(t, e, i) {
			function n(t, e) {
				var i = t.id,
					...
					s = t.next,
					c = t.pipeline;
				if (!e.error && o !== r.WORKING && o !== r.ERROR)
					if (o === r.COMPLETE) s ? n(s, e) : c.flowOut(e);
					else {
		...
		101: [(function(i, n, o) {
			...
			n.exports = function(i, n) {
				var o = i.url,
					r = jsb.fileUtils.getStringFromFile(o);
					...
					t.flowInDeps(e, l, (function(t, e) {
						...
						for (var u = 0; u < l.length; u++) {
							...
							if (o = e.map[_]) {
								...
								if (o.complete || o.content) o.error ? cc._throw(o.error) : v.call(y, o);
								else {
									var m = a.getQueue(o),
										C = m._callbackTable[d];
		...
		104: [(function(i, n, o) {
			...
			var c = i("./component-scheduler"),
				a = i("./platform/CCObject").Flags,
				l = i("./platform/js"),
				h = a.IsPreloadStarted,
				u = a.IsOnLoadStarted,
				d = a.IsOnLoadCalled,
				f = a.Deactivating,
				_ = "c.onLoad();c._objFlags|=" + d,
				p = cc.Class({
				...
				g = c.createInvokeImpl("c.__preload();"),
				y = c.createInvokeImpl(_),
				v = new l.Pool(4);
			v.get = function() {
				var t = this._get() || {
					preload: new p(g),
			...
			var m = cc.Class({
				...
				_activateNodeRecursively: function(t, e, i, n) {
					if (t._objFlags & f) cc.errorID(3816, t.name);
					else {
						t._activeInHierarchy = !0;
						for (var o = t._components.length, s = 0; s < o; ++s) {
							var c = t._components[s];
							if (c instanceof cc.Component) this.activateComp(c, e, i, n);
							else {
								r(t, c, s);
								--s;
								--o;
		...
		105: [(function(t, e, i) {
			...
			function o() {}
			var r = t("./CCPhysicsTypes").PTM_RATIO,
				s = t("./CCPhysicsTypes").ContactType,
				c = [],
				a = [cc.v2(), cc.v2()];
			0;
			var l = {
			...
			o.prototype.getWorldManifold = function() {
				var t = l.points,
					e = l.separations,
					i = l.normal,
					n = cc.PhysicsUtils.getContactWorldManifoldWrapper(this._b2contact),
					o = n.getCount();
				t.length = e.length = o;
				for (var r = 0; r < o; r++) {
					var s = a[r];
		...
		106: [(function(t, e, i) {
			var n = t("./CCPhysicsTypes").ContactType,
				o = t("./CCPhysicsTypes").BodyType,
				r = t("./CCPhysicsTypes").RayCastType,
				s = t("./CCPhysicsTypes").PTM_RATIO,
				c = (t("./CCPhysicsTypes").ANGLE_TO_PHYSICS_ANGLE,
					t("./CCPhysicsTypes").PHYSICS_ANGLE_TO_ANGLE, new b2.AABB()),
				a = new b2.Vec2(),
				l = new b2.Vec2(),
				h = cc.Class({
					mixins: [cc.EventTarget],
					...
					update: function(t) {
						...
						if (e && this.enabled) {
							...
							this._steping = !0;
							var i = h.VELOCITY_ITERATIONS,
								n = h.POSITION_ITERATIONS;
		...
		108: [(function(i, n, o) {
			...
			function c(t) {
				_(t);
				for (var e, i, n, o, p, y, v = [], m = cc.v2(), C = cc.v2(), T = 0, b = 0, S = 0; S < t.length; ++S)
					if (a(S, t)) {
						i = n = 1e8;
						for (var E = 0; E < t.length; ++E) {
						...
						if (T == (b + 1) % t.length) {
							...
							for (E = T; E <= b; ++E)
								if (function(t, e, i) {
										...
										for (var n = 0; n < i.length; ++n)
											if ((n + 1) % i.length != t && n != t && (n + 1) % i.length != e && n != e) {
												var o = cc.v2();
		...
		109: [(function(t, e, i) {
			var n = t("./CCPhysicsTypes").PTM_RATIO,
				o = t("./CCPhysicsTypes").ANGLE_TO_PHYSICS_ANGLE,
				r = t("./CCPhysicsTypes").PHYSICS_ANGLE_TO_ANGLE,
				s = t("./utils").getWorldRotation,
				c = t("./CCPhysicsTypes").BodyType,
				a = new b2.Vec2(),
				l = new b2.Vec2(),
				h = cc.Vec2.ZERO,
				u = cc.Class({
			...
			var n = t("../CCPhysicsTypes").PTM_RATIO,
				o = cc.Class({
					...
					_createShape: function(t) {
						var e = Math.abs(t.x),
							i = Math.abs(t.y),
							o = this.size.width / 2 / n * e,
							r = this.size.height / 2 / n * i,
							s = this.offset.x / n * e,
							c = this.offset.y / n * i,
		...
		113: [(function(t, e, i) {
			var n = t("../CCPhysicsTypes").PTM_RATIO,
				...
				r = cc.Class({
						...
						if (!this._inited) {
							...
							if (t) {
								...
								if (e) {
									var i = t.node,
										n = o(i),
										r = 0 === n.x && 0 === n.y ? [] : this._createShape(n);
					...
					getAABB: function() {
						for (var t = 1e7, e = 1e7, i = -1e7, o = -1e7, r = this._fixtures, s = 0; s < r.length; s++)
							for (var c = r[s], a = c.GetShape().GetChildCount(), l = 0; l < a; l++) {
								var h = c.GetAABB(l);
				...
				o = cc.Class({
					...
					__init: function() {
						if (!this._inited) {
							...
							if (this._isValid()) {
								var t = cc.director.getPhysicsManager()._getWorld(),
									e = this._createJointDef();
								if (!e) return;
		...
		126: [(function(i, n, o) {
			...
			var c = i("../assets/CCAsset"),
				a = i("./utils").callInNextTick,
				l = i("../load-pipeline/CCLoader"),
				h = i("../load-pipeline/pack-downloader"),
				u = i("../load-pipeline/auto-release-utils"),
				d = i("../utils/decode-uuid"),
				f = i("../load-pipeline/md5-pipe"),
				_ = "",
				p = "",
				g = {},
				y = {
					loadAsset: function(i, n, o) {
						...
						l.load(s, (function(t, e) {
							if (t || !e) t = new Error("[AssetLibrary] loading JSON or dependencies failed: " + (t ? t.message : "Unknown error"));
							else {
		...
		127: [(function(i, n, o) {
				...
				if (l) {
					...
					o = c ? [c] : (function(t, e, i) {
						...
						for (var o = [], s = [t].concat(e), c = 0; c < s.length; c++) {
							var a = s[c];
							if (a)
								for (var l = n(a), h = 0; h < l.length; h++) r(o, l[h]);
						}
						var u = i.ctor;
						u && o.push(u);
						return o;
				...
				var r = (function(i, n) {
					for (var o = [], r = "", s = 0; s < n.length; s++) {
						...
						if (a in i) {
							...
							var h, u = i[a];
							if ("object" === ("object" == (e = typeof u) ? t(u) : e) && u) h = u instanceof cc.ValueType ? d(u) : Array.isArray(u) ? "[]" : "{}";
							else if ("function" === ("object" == (e = typeof u) ? t(u) : e)) {
								var _ = o.length;
								o.push(u);
								h = "F[" + _ + "]()";
			...
			var m = i("./js"),
				C = i("./CCEnum"),
				T = i("./utils"),
				b = (T.isPlainEmptyObj_DEV,
					T.cloneable_DEV, i("./attribute")),
				S = b.DELIMETER,
				E = b.getTypeChecker,
				x = i("./preprocess-class");
			i("./requiring-frame");
			var A = ["name", "extends", "mixins", "ctor", "__ctor__", "properties", "statics", "editor", "__ES6__"],
				...
				w = function(t, e, i, n) {
					...
					if (r > 0) {
						...
						if (1 === r) o += "CCClass.__ctors__[0" + c;
						else {
		...
		128: [(function(i, n, o) {
			...
			function u(i, n, o, r, s, c) {
				var a = r && (_.getFullFormOfProperty(r) || r),
					l = n[o],
					h = p.mixin(l || {}, a || {});
				if (s && (s.get || s.set)) {
					s.get && (h.get = s.get);
			...
			var _ = i("./preprocess-class"),
				...
				T = f(c),
				b = d(y, "requireComponent"),
				S = f(v),
				E = d(m, "executionOrder"),
				x = f(c),
				A = f(c),
				N = f(v),
				O = f(v),
			...
			function r(i) {
				...
				for (var n = -1, o = Object.keys(i), r = 0; r < o.length; r++) {
					...
					if (-1 === a) {
						a = ++n;
						i[c] = a;
					} else if ("number" === ("object" == (e = typeof a) ? t(a) : e)) n = a;
					else if ("string" === ("object" == (e = typeof a) ? t(a) : e) && Number.isInteger(parseFloat(c))) continue;
					var l = "" + a;
					if (c !== l) {
						0;
						s.value(i, l, c);
		...
		131: [(function(i, n, o) {
			...
			u._destruct = function() {
				...
				if (!n) {
					n = (function(i, n) {
						var o, r = {};
						for (o in i)
							if (i.hasOwnProperty(o)) switch ("object" == (e = typeof i[o]) ? t(i[o]) : e) {
								case "string":
									r[o] = "";
									break;
						...
						if (cc.Class._isCCClass(n))
							for (var s = cc.Class.Attr.getClassAttrs(n), c = n.__props__, l = 0; l < c.length; l++) {
						...
						var u = i instanceof cc._BaseNode || i instanceof cc.Component,
							d = "";
						for (o in r)
							if (!u || "_id" !== o) {
								var f;
			...
			u._destroyImmediate = function() {
				if (this._objFlags & l) cc.errorID(5e3);
				else {
		...
		132: [(function(i, n, o) {
			if (!cc.sys) {
				...
				var d = !1,
					...
					_ = "",
					p = 0,
					g = /android (\d+(?:\.\d+)+)/i.exec(h) || /android (\d+(?:\.\d+)+)/i.exec(c.platform);
				if (g) {
					d = !0;
					_ = g[1] || "";
					p = parseInt(_) || 0;
				...
				var A = T.toDataURL("image/webp").startsWith("data:image/webp"),
					N = !!T.getContext("2d"),
					O = !1;
		...
		134: [(function(i, n, o) {
			...
			function s(i, n, o) {
				var s, a, l;
				if ("function" === ("object" == (e = typeof i) ? t(i) : e)) a = (s = c(i)).constructor.prototype;
				else {
					var h = i;
					if (!(s = h.__attrs__)) {
				...
				if ("object" === ("object" == (e = typeof o) ? t(o) : e))
					for (l in o) 95 !== l.charCodeAt(0) && (a[n + u + l] = o[l]);
				else 0;
			}
			...
			var h = i("./js"),
				u = (i("./utils").isPlainEmptyObj_DEV, "$_$");
			cc.Integer = "Integer";
			cc.Float = "Float";
			0;
			cc.Boolean = "Boolean";
		...
		135: [(function(i, n, o) {
			...
			l.removeBy = function(t, e) {
				for (var i = this.callbacks, n = this.targets, o = 0; o < t.length; ++o)
					if (t[o] === e) {
						a(i, o);
						a(n, o);
						--o;
			...
			l.has = function(t, e, i) {
				...
				i = i || null;
				for (var s = n.targets, c = 0; c < o.length; ++c)
					if (o[c] === e && s[c] === i) return !0;
				return !1;
			};
			l.removeAll = function(i) {
				if ("string" === ("object" == (e = typeof i) ? t(i) : e)) {
					...
					if (n)
						if (n.isInvoking) n.cancelAll();
						else {
							h.put(n);
							delete this._callbackTable[i];
						}
				} else if (i)
					for (var o in this._callbackTable) {
						var r = this._callbackTable[o];
						if (r.isInvoking)
							for (var s = r.targets, c = 0; c < s.length; ++c) s[c] === i && r.cancel(c);
						else r.removeBy(r.targets, i);
					}
			};
			l.remove = function(t, e, i) {
				...
				if (n) {
					i = i || null;
					for (var o = n.callbacks, r = n.targets, s = 0; s < o.length; ++s)
						if (o[s] === e && r[s] === i) {
							if (n.isInvoking) n.cancel(s);
							else {
								a(o, s);
								a(r, s);
							}
		...
		137: [(function(i, n, o) {
			...
			var h = (function() {
				...
				function n(t, e, i, n, o) {
					var s;
					if (n.hasOwnProperty("__deserialize__")) s = n.__deserialize__;
					else {
						s = h(t, n);
				...
				o.deserialize = function(t) {
					...
					(function(t) {
						var e, i, n, o = t.deserializedList,
							r = t._idPropList,
							s = t._idList,
							c = t._idObjList;
					...
					h = function(i, n) {
						for (var o = s.DELIMETER + "type", h = s.DELIMETER + "rawType", u = (s.DELIMETER,
							...
							if (p[T + h]) {
								...
								if (v) {
									var A, N = p[T + o];
									if (void 0 === x && N) A = N === cc.String || N === cc.Integer || N === cc.Float || N === cc.Boolean;
									else {
			...
			cc.deserialize = function(i, n, o) {
				var s = (o = o || {}).classFinder || r._getClassById,
					c = o.createAssetRefs || cc.sys.platform === cc.sys.EDITOR_CORE,
					a = o.customEnv,
					u = o.ignoreEditorOnly;
				0;
		...
		140: [(function(i, n, o) {
			...
			var d = i("./CCObject"),
				f = d.Flags.Destroyed,
				_ = d.Flags.PersistentMask,
				p = i("./attribute"),
				g = i("./js"),
				y = i("./CCClass"),
				v = i("./compiler"),
				m = p.DELIMETER + "serializable",
				C = p.DELIMETER + "default",
				T = y.IDENTIFIER_RE,
				b = y.escapeForJS,
				S = "var ",
				E = "o",
			...
			N.enumerateObject = function(i, n) {
				var o = n.constructor;
				if (cc.Class._isCCClass(o)) this.enumerateCCClass(i, n, o);
				else
					for (var r in n)
						if (n.hasOwnProperty(r) && (95 !== r.charCodeAt(0) || 95 !== r.charCodeAt(1) || "__type__" === r)) {
							var s = n[r];
		...
		141: [(function(i, n, o) {
			...
			function c(i, n, o) {
				...
				if (cc.Class._isCCClass(r))(function(i, n, o, r) {
					...
					for (var s in i)
						if (i.hasOwnProperty(s) && (95 !== s.charCodeAt(0) || 95 !== s.charCodeAt(1) || "__type__" === s)) {
							var c = i[s];
							if ("object" === ("object" == (e = typeof c) ? t(c) : e) && c) {
								if (c === n) continue;
								n[s] = c._iN$t || a(c, o);
			...
			function a(i, n) {
				...
				if (cc.Class._isCCClass(u)) {
					if (n)
						...
						} else if (n instanceof cc._BaseNode)
						if (i instanceof cc._BaseNode) {
		...
		142: [(function(i, n, o) {
			...
			var h = new(i("./id-generater"))("TmpCId."),
				u = {
					isNumber: function(i) {
			...
			u.formatStr = function() {
				...
				var n = arguments[0];
				if (1 === i) return "" + n;
				if ("string" === ("object" == (e = typeof n) ? t(n) : e) && g.test(n))
					for (var o = 1; o < i; ++o) {
						var r = arguments[o],
							s = "number" === ("object" == (e = typeof r) ? t(r) : e) ? g : y;
						s.test(n) ? n = n.replace(s, r) : n += " " + r;
					} else
						for (var c = 1; c < i; ++c) n += " " + arguments[c];
				return n;
			};
		...
		143: [(function(i, n, o) {
			function r(t, e, i, n) {
				if (t.get || t.set) 0;
				else if (t.hasOwnProperty("default")) {
					var o = "_N$" + e;
					t.get = function() {
						return this[o];
					};
		...
		158: [(function(t, e, i) {
			...
			cc.pAngleSigned = function(t, e) {
				var i = cc.pNormalize(t),
					o = cc.pNormalize(e),
					r = Math.atan2(i.x * o.y - i.y * o.x, cc.pDot(i, o));
		...
		162: [(function(i, n, o) {
			cc.WebGLColor = function(i, n, o, r, s, c) {
				...
				this._offset = c || 0;
				var a = this._arrayBuffer,
					l = this._offset;
				this._view = new Uint8Array(a, l, 4);
				this._view[0] = i || 0;
				this._view[1] = n || 0;
				this._view[2] = o || 0;
				if ("number" === ("object" == (e = typeof r) ? t(r) : e)) this._view[3] = r;
				else {
					this._view[3] = 255;
					this.a_undefined = !0;
				}
		...
		167: [(function(t, e, i) {
			...
			var n = cc.Class({
				...
				_onNodePositionChanged: function() {
					...
					if (this._motionStreak) {
						var t = this.node,
							e = t.getNodeToWorldTransform(),
							i = e.tx - (t.width / 2 + t.anchorX * t.width),
							n = e.ty - (t.height / 2 + t.anchorY * t.height);
			...
			var n = cc.Enum({
				...
				l = cc.Class({
					...
					_refreshLayerEntities: function() {
						var t, e, i = this.node.getChildren(),
							n = [],
							o = [],
							r = [];
						...
						for (t = i.length - 1; t >= 0; t--) {
							var l = i[t],
								h = l.getComponent(cc.TiledLayer),
								u = l.getComponent(cc.TiledObjectGroup);
							if (h) {
								var d = h.getLayerName();
								d || (d = l._name);
								if (c.indexOf(d) < 0) h._tryRemoveNode();
								else {
									n.push(l);
								...
								_ || (_ = l._name);
								if (a.indexOf(_) < 0) u._tryRemoveNode();
								else {
									o.push(l);
						...
						for (t = 0, e = c.length; t < e; t++) {
							var y = c[t],
								v = this._sgNode.getLayer(y),
								m = g.indexOf(y);
							if (m < 0) {
								var C = this.node.getChildByName(y),
									T = null;
								if (C && !C.getComponent(cc._SGComponent)) T = C.addComponent(cc.TiledLayer);
								else {
									C = new cc.Node(y);
						...
						for (t = 0, e = a.length; t < e; t++) {
							...
							if ((m = b.indexOf(y)) < 0) {
								var E = null;
								if ((C = this.node.getChildByName(y)) && !C.getComponent(cc._SGComponent)) E = C.addComponent(cc.TiledObjectGroup);
								else {
									C = new cc.Node(y);
									this.node.addChild(C);
						...
						var N = [],
							O = [],
							L = this._sgNode.getChildren();
						for (t = 0, e = L.length; t < e; t++)
							if ((l = L[t]) instanceof _ccsg.TMXLayer) {
					...
					_childAdded: function(t) {
						var e = t.detail;
						if (e) {
							var i = e.getComponent(cc.TiledLayer),
								n = e.getComponent(cc.TiledObjectGroup);
							if (!i && !n) {
					...
					_syncChildrenOrder: function() {
						for (var t = this.node.children, e = 0, i = t.length; e < i; e++) {
							var n = t[e],
								o = n.getComponent(cc.TiledLayer),
								r = n.getComponent(cc.TiledObjectGroup),
								s = n.getSiblingIndex();
			...
			dragonBones.ArmatureDisplay = cc.Class({
				...
				getAnimationNames: function(t) {
					...
					if (this._dragonBonesData) {
						...
						if (i)
							for (var n in i.animations) i.animations.hasOwnProperty(n) && e.push(n);
					}
					return e;
				},
			...
			sp.Skeleton = cc.Class({
				...
				properties: {
					...
					animation: {
						...
						set: function(t) {
							...
							if (t) this.setAnimation(0, t, this.loop);
							else {
								this.clearTrack(0);
								this.setToSetupPose();
							}
				...
				_createSgNode: function() {
					if (this.skeletonData) {
						...
						var i = this.skeletonData.rawUrl,
							n = this.skeletonData.atlasUrl;
						if (n) {
							if ("string" !== ("object" == (e = typeof n) ? t(n) : e)) {
								cc.errorID(7505);
								return null;
		...
		185: [(function(t, e, i) {
			function n(t, e, i) {
				if (t)
					for (var n = t._owner.getComponentsInChildren(cc._SGComponent), o = 0; o < n.length; ++o) {
						var r = n[o];
			...
			function r(t, e) {
				var i = cc.ActionManager.prototype,
					n = i[t];
				i[t] = function() {
			...
			cc.Follow = cc.BaseJSAction.extend({
				...
				step: function(t) {
					var e = this.getTarget(),
						i = e.convertToWorldSpaceAR(cc.Vec2.ZERO),
						n = this._followedNode.convertToWorldSpaceAR(cc.Vec2.ZERO),
						o = cc.pSub(i, n),
						r = e.parent.convertToNodeSpaceAR(cc.pAdd(o, this._halfScreenSize));
					if (this._boundarySet) {
			...
			for (var f = [
					...
					["pauseTarget", 0],
					["resumeTarget", 0]
				], _ = 0; _ < f.length; ++_) r.apply(null, f[_]);
		...
		186: [(function(t, e, i) {
			...
			(function(e, i) {
				...
				e.emit = function(t) {
					...
					if (e)
						for (var i = 0; i < e.length; i++) e[i].call(this, this);
				};
				e.off = function(t, e) {
					var i = this._eventList[t];
					if (!i) return !1;
		...
		188: [(function(i, n, o) {
			"use strict";
			var r = i("../cocos2d/core/load-pipeline/auto-release-utils"),
				s = i("../cocos2d/core/component-scheduler"),
				c = i("../cocos2d/core/node-activator"),
				a = i("../cocos2d/core/event/event-listeners");
				...
				loadScene: function(t, e, i) {
					...
					if (n) {
						...
						if (cc.runtime && o !== this._launchSceneUuid) {
							var r = this,
								s = cc.path.basename(n.url) + "_" + n.uuid;
		...
		193: [(function(i, n, o) {
			"use strict";
			var r = i("../cocos2d/core/platform/js").Pool,
				s = i("../cocos2d/core/event/event");
			i("../cocos2d/core/event-manager/CCEvent");
			...
			s.EventTouch.pool.get = function(t) {
				var e = t.getTouches(),
					i = this._get() || new s.EventTouch(e, !0);
				i.eventPhase = cc.Event.NONE;
			...
			cc.eventManager.addListener = function(i, n) {
				...
				if ("number" === ("object" == (e = typeof n) ? t(n) : e)) {
					...
					var o = n;
					if (n instanceof cc._BaseNode) o = n._sgNode;
					else if (!(o instanceof _ccsg.Node)) {
						cc.warnID(3506);
						return;
					}
			...
			cc.eventManager.pauseTarget = function(t, e) {
				var i = t;
				t._eventPaused = !0;
				if (t instanceof cc._BaseNode) i = t._sgNode;
				else if (!(i instanceof _ccsg.Node)) {
					cc.warnID(3506);
					return;
				}
				if (i !== t && !i.isRunning()) {
			...
			cc.eventManager.resumeTarget = function(t, e) {
				t._eventPaused = !1;
				if (t instanceof cc._BaseNode) t = t._sgNode;
				else if (!(t instanceof _ccsg.Node)) {
					cc.warnID(3506);
					return;
				}
		...
		194: [(function(i, n, o) {
			...
			cc.game = {
				...
				run: function(i, n) {
					if ("function" === ("object" == (e = typeof i) ? t(i) : e)) cc.game.onStart = i;
					else {
						i && (cc.game.config = i);
				...
				_loadConfig: function() {
					if (this.config) this._initConfig(this.config);
						...
						var t = jsb.fileUtils.getStringFromFile("project.json"),
							e = JSON.parse(t);
						this._initConfig(e || {});
					} catch (t) {
		...
		195: [(function(i, n, o) {
			...
			r.prototype.setFontSize = function(t) {
				this._fontSize = t;
				if (this._labelType === _ccsg.Label.Type.SystemFont) this.setSystemFontSize(t);
				else if (this._labelType === _ccsg.Label.Type.BMFont) this.setBMFontSize(t);
			...
			r.prototype.setContentSize = function(i, n) {
				var o = "number" === ("object" == (e = typeof i.width) ? t(i.width) : e) ? i.width : i,
					r = "number" === ("object" == (e = typeof i.height) ? t(i.height) : e) ? i.height : n;
			...
			cc.Label = function(t, e, i, n) {
				e = e || "Arial";
				var o = cc.path.extname(e),
					s = _ccsg.Label.Type.TTF;
				this._fontSize = n;
				var c;
				if (".ttf" === o) {
					var a = {
		...
		196: [(function(t, e, i) {
			...
			function s(t, e) {
				var i = t.url,
					n = cc.textureCache.getTextureForKey(i);
				if (n) return n;
			...
			if (n) {
				...
				o.setSpriteFrame = function(t) {
					...
					var e = t.getOriginalSize(),
						i = t.getRect(),
						n = t.getOffset(),
						o = (e.width + 2 * n.x - i.width) / 2,
						r = e.width - o - i.width,
						s = (e.height + 2 * n.y - i.height) / 2,
						c = e.height - s - i.height;
					this._trim.left = o;
					this._trim.right = r;
					this._trim.top = c;
					this._trim.bottom = s;
		...
		206: [(function(i, n, o) {
			...
			window.__decorate = function(i, n, o, r) {
				var s, c = arguments.length,
					a = c < 3 ? n : null === r ? r = Object.getOwnPropertyDescriptor(n, o) : r;
				if ("object" === ("object" == (e = typeof Reflect) ? t(Reflect) : e) && "function" === ("object" == (e = typeof Reflect.decorate) ? t(Reflect.decorate) : e)) a = Reflect.decorate(i, n, o, r);
				else
					for (var l = i.length - 1; l >= 0; l--)(s = i[l]) && (a = (c < 3 ? s(a) : c > 3 ? s(n, o, a) : s(n, o)) || a);
			...
			window.__values = function(i) {
				var n = "function" === ("object" == (e = typeof Symbol) ? t(Symbol) : e) && i[Symbol.iterator],
					o = 0;
				return n ? n.call(i) : {
					next: function() {
			...
			window.__read = function(i, n) {
				...
				try {
					for (;
						(void 0 === n || n-- > 0) && !(r = c.next()).done;) a.push(r.value);
				} catch (t) {
					s = {
						error: t
					};
